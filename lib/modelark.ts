...
/**
 * Tarifs indicatifs par seconde de vidéo générée, en dollars, relevés dans la
 * documentation ModelArk (août 2026, promotions en cours incluses). Ils servent
 * à afficher un ordre de grandeur AVANT de dépenser — jamais à facturer.
 * À corriger depuis la console ModelArk pour le plan réellement souscrit.
 */
export const TARIFS = {
